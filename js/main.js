...
window.onload = function() {
	...
	$("#nav").contents().find("#nav-home").mouseenter(function() {
		$(".page1").fadeOut(150, function() {
			$(this).css("backgroundImage", "url(img/home-bg.jpg)")
		}).fadeIn(150);
	});
	$("#nav").contents().find("#nav-home").mouseleave(function() {
		$(".page1").fadeOut(150, function() {
			$(".page1").css("backgroundImage", "url(img/welcome-bg-1.png)")
		}).fadeIn(150);
	});
	$("#nav").contents().find("#nav-blog").mouseenter(function() {
		$(".page1").fadeOut(150, function() {
			$(this).css("backgroundImage", "url(img/blog-bg.jpg)")
		}).fadeIn(150);
	});
	$("#nav").contents().find("#nav-blog").mouseleave(function() {
		$(".page1").fadeOut(150, function() {
			$(this).css("backgroundImage", "url(img/welcome-bg-1.png)")
		}).fadeIn(150);
	});
	$("#nav").contents().find("#nav-about").mouseenter(function() {
		$(".page1").fadeOut(150, function() {
			$(this).css("backgroundImage", "url(img/about-bg.jpg)")
		}).fadeIn(150);
	});
	$("#nav").contents().find("#nav-about").mouseleave(function() {
		$(".page1").fadeOut(150, function() {
			$(this).css("backgroundImage", "url(img/welcome-bg-1.png)")
		}).fadeIn(150);
	});
	$("#nav").contents().find("#nav-think").mouseenter(function() {
		$(".page1").fadeOut(150, function() {
			$(this).css("backgroundImage", "url(img/think-bg.jpg)")
		}).fadeIn(150);
	});
	$("#nav").contents().find("#nav-think").mouseleave(function() {
		$(".page1").fadeOut(150, function() {
			$(this).css("backgroundImage", "url(img/welcome-bg-1.png)")
		}).fadeIn(150);
	});
	$("#nav").contents().find("#nav-relax").mouseenter(function() {
		$(".page1").fadeOut(150, function() {
			$(this).css("backgroundImage", "url(img/game-bg.jpg)")
		}).fadeIn(150);
	});
	$("#nav").contents().find("#nav-relax").mouseleave(function() {
		$(".page1").fadeOut(150, function() {
			$(this).css("backgroundImage", "url(img/welcome-bg-1.png)")
		}).fadeIn(150);
	});
